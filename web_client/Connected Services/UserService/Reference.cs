...
namespace web_client.UserService {
    ...
    public partial class User : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private web_client.UserService.Passport PassportField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private web_client.UserService.sex SexField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public web_client.UserService.Passport Passport {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public web_client.UserService.sex Sex {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="UserService.IUsersManagementService")]
    public interface IUsersManagementService {
        ...
        web_client.UserService.Returnable ListUsers(string sessionKey, byte[] hash);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUsersManagementService/ListUsers", ReplyAction="http://tempuri.org/IUsersManagementService/ListUsersResponse")]
        System.Threading.Tasks.Task<web_client.UserService.Returnable> ListUsersAsync(string sessionKey, byte[] hash);
        ...
        web_client.UserService.Returnable Login([System.ServiceModel.MessageParameterAttribute(Name="login")] string login1, string password, byte[] hash);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUsersManagementService/Login", ReplyAction="http://tempuri.org/IUsersManagementService/LoginResponse")]
        System.Threading.Tasks.Task<web_client.UserService.Returnable> LoginAsync(string login, string password, byte[] hash);
        ...
        web_client.UserService.Returnable Logout(string sessionKey, byte[] hash);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUsersManagementService/Logout", ReplyAction="http://tempuri.org/IUsersManagementService/LogoutResponse")]
        System.Threading.Tasks.Task<web_client.UserService.Returnable> LogoutAsync(string sessionKey, byte[] hash);
        ...
        web_client.UserService.Returnable Register(web_client.UserService.User data, byte[] hash);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUsersManagementService/Register", ReplyAction="http://tempuri.org/IUsersManagementService/RegisterResponse")]
        System.Threading.Tasks.Task<web_client.UserService.Returnable> RegisterAsync(web_client.UserService.User data, byte[] hash);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUsersManagementServiceChannel : web_client.UserService.IUsersManagementService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UsersManagementServiceClient : System.ServiceModel.ClientBase<web_client.UserService.IUsersManagementService>, web_client.UserService.IUsersManagementService {
        ...
        public web_client.UserService.Returnable ListUsers(string sessionKey, byte[] hash) {
            return base.Channel.ListUsers(sessionKey, hash);
        }
        
        public System.Threading.Tasks.Task<web_client.UserService.Returnable> ListUsersAsync(string sessionKey, byte[] hash) {
            return base.Channel.ListUsersAsync(sessionKey, hash);
        }
        
        public web_client.UserService.Returnable Login(string login1, string password, byte[] hash) {
            return base.Channel.Login(login1, password, hash);
        }
        
        public System.Threading.Tasks.Task<web_client.UserService.Returnable> LoginAsync(string login, string password, byte[] hash) {
            return base.Channel.LoginAsync(login, password, hash);
        }
        
        public web_client.UserService.Returnable Logout(string sessionKey, byte[] hash) {
            return base.Channel.Logout(sessionKey, hash);
        }
        
        public System.Threading.Tasks.Task<web_client.UserService.Returnable> LogoutAsync(string sessionKey, byte[] hash) {
            return base.Channel.LogoutAsync(sessionKey, hash);
        }
        
        public web_client.UserService.Returnable Register(web_client.UserService.User data, byte[] hash) {
            return base.Channel.Register(data, hash);
        }
        
        public System.Threading.Tasks.Task<web_client.UserService.Returnable> RegisterAsync(web_client.UserService.User data, byte[] hash) {
